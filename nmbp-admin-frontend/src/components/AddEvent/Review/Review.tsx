      ...
      <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-6">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div>
              <p className="text-xs text-[#6B7280] mb-1">Activity Type</p>
            ...
            <div>
              <p className="text-xs text-[#6B7280] mb-1">Number of Female</p>
              <p className="text-sm font-medium text-[#374151]">
                {formData.numberOfFemale || "40"}
              </p>
            </div>
            <div>
              <p className="text-xs text-[#6B7280] mb-1">Number of Male</p>
              <p className="text-sm font-medium text-[#374151]">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="border border-[#E5E7EB] rounded-lg overflow-hidden bg-[#F9FAFB]">
              <div className="h-32 bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center text-white text-3xl">
                🖼️
              </div>
              <div className="p-3 bg-white border-t border-[#E5E7EB]">
                <p className="text-xs font-medium text-[#374151] truncate mb-1">
