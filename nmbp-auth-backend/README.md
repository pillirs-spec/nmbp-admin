Overview
nmbp-auth-backend is an authentication microservice built with TypeScript and Node.js. It provides authentication and authorization APIs for the RBAC/UBAC module, supporting secure user management and token-based authentication.
...
• API Documentation: Swagger integration for API reference (http://localhost:7001/api/v1/auth/docs).
